...
I focus on understanding **system behavior, data flow, failure modes, transaction boundaries, and operational constraints** rather than treating a particular technology stack as the goal.

For complex systems, I prefer making architecture, integration flows, and operational processes explicit before solving the implementation problem.
